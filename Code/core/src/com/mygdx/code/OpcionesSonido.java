...
//		table2.addActor(checkSound);
	...
	public void render(float delta) {
	    ...
	    batch.draw(barra, anchoPantalla*47/100, altoPantalla*67/100, AnchoBoton*Volumen/9, AltoBoton/2);
	    
	    
	    if(Silenciar) {
			
			batch.draw(new Texture("botoncheckedplchld.png"), anchoPantalla*58/100, altoPantalla*57/100, AltoBoton/2, AltoBoton/2);
			
		}else {
			
			batch.draw(new Texture("botonuncheckedplchld.png"), anchoPantalla*58/100, altoPantalla*57/100, AltoBoton/2, AltoBoton/2);
	    ...
	    if(Gdx.graphics.isFullscreen()) {
	    	...
	    	batch.draw(seleccionar, anchoPantalla*39/100, altoPantalla*65/100 - altoPantalla*10/100*commandnum, AnchoBoton/2, AltoBoton); //Pantalla completa
		    
	     
	    }else {
	    	batch.draw(seleccionar, anchoPantalla*39/100, altoPantalla*65/100 - altoPantalla*10/100*commandnum);  // Modo ventana
