...
public class PantallaPartida implements Screen {
	...
	private Body crearCuerpo(Vector2 posicion, BodyType tipo, float densidad, float friccion, float rebote, boolean sensor,Sprite foto,float escala,Vector2 tamanio) {
